...
image_path = Path('/home/buybluepants/Documents/Thesis/Using-Large-Language-Models-to-identify-breast-cancer-cells/datasets/Breast Cancer Patients MRI\'s/validation/Sick/S_75.jpg')
localDataset = Path('/home/buybluepants/Documents/Thesis/Using-Large-Language-Models-to-identify-breast-cancer-cells/datasets/Breast Cancer Patients MRI\'s')
...
instruction = "Evaluate the existance of breast cancer in the MRI exam image. Respond with only 'positive' or 'negative' according to the result of the analysis of your evaluation of the second image. Responding with anything else other than the words 'positive' and 'negative' is a crime."
input = encode_image_to_base64(image_path)
huggingface_model_name = "buybluepants/FineTuneTest_Deepseek-1.5B"
...
model.push_to_hub(huggingface_model_name, token = "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") 
tokenizer.push_to_hub(huggingface_model_name, token = "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")

# Merge to 16bit
if True: model.save_pretrained_merged("model", tokenizer, save_method = "merged_16bit",)
if True: model.push_to_hub_merged(huggingface_model_name, tokenizer, save_method = "merged_16bit", token = "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")
