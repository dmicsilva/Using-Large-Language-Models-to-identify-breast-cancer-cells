...
dest_healthy = os.path.join(cwd, 'datasets', 'datasetPrepping', 'Json_mriDataset', 'healthy')
dest_sick = os.path.join(cwd, 'datasets', 'datasetPrepping', 'Json_mriDataset', 'sick')
